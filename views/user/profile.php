                ...
                <div class="modal-content">
                    ...
                    <form action="<?php echo site_url();
                        ...
                        <div class="modal-form-left">
                            ...
                            <div class="checkbox">
                                <label><input name="onAddress" type="checkbox" id="form-addr-chk" value="Yes">Dolazim na adresu</label></div>
                            <div class="checkbox">
                                <label><input name="online" type="checkbox" id="form-onl-chk" value="Yes">Držim online časove</label></div>
                            <div class="checkbox">
                                <label><input name="group" type="checkbox" id="form-grp-chk" value="Yes">Držim grupne časove</label></div>
                        </div>
